...
This includes modifications to server startup listeners as well as changes to code that connect front-end and backend components, such as
adding a new `LitTemplate` class, or adding a new CSS import and using it in Java via `@CssImport` annotation.
